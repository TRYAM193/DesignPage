      ...
      ContentComponent = () => (
        <div className="sidebar-content">
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: '10px'}}>
             ...
             <div className='p-3 border rounded-md cursor-pointer hover:bg-gray-100' style={{padding: '5px', border: '1px solid #ccc', borderRadius: '6px', cursor: 'pointer', textAlign: 'center'}} onClick={() => addSubheading()}><h3 style={{margin: '0'}}> Add Subheading </h3></div>
             {/* ... more text presets ... */}
          </div>
        </div>
      );
