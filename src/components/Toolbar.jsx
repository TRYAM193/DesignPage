    ...
    <div className="property-panel-content">
      ...
      <div className="property-group">
        ...
        <div className="control-row">
          ...
          <input type="color" className="color-input" value={liveProps.shadowColor || '#000000'} onInput={(e) => handleLiveUpdate('shadowColor', e.target.value, object)} onChange={(e) => handleUpdateAndHistory('shadowColor', e.target.value)} />
        </div>
        {/* ... (Blur/Offset controls) ... */}
        <div className="control-row"><label className="control-label">Blur</label><input type="range" className="slider-input" min="0" max="50" value={liveProps.shadowBlur || 0} onInput={(e) => handleLiveUpdate('shadowBlur', Number(e.target.value), object)} onMouseUp={(e) => handleUpdateAndHistory('shadowBlur', Number(e.target.value))} /></div>
        <div className="control-row"><label className="control-label">Offset X</label><input type="range" className="slider-input" min="-20" max="20" value={liveProps.shadowOffsetX || 0} onInput={(e) => handleLiveUpdate('shadowOffsetX', Number(e.target.value), object)} onMouseUp={(e) => handleUpdateAndHistory('shadowOffsetX', Number(e.target.value))} /></div>
        <div className="control-row"><label className="control-label">Offset Y</label><input type="range" className="slider-input" min="-20" max="20" value={liveProps.shadowOffsetY || 0} onInput={(e) => handleLiveUpdate('shadowOffsetY', Number(e.target.value), object)} onMouseUp={(e) => handleUpdateAndHistory('shadowOffsetY', Number(e.target.value))} /></div>
      </div>
